        ...
        <div class="card-body">
            <form action="{{ route('products.update', ['product'=>$product->id])}}" method="POST" class="form-horizontal">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-3">
                        <input type="text" name="refcode" value="{{$product->refcode}}" class="form-control @error('refcode') is-invalid @enderror" />
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea type="text" name="description" rows="3" class="form-control @error('description') is-invalid @enderror">{{$product->description}}</textarea>
                    </div>
                </div>
                ...
                <div class="form-group row" style="margin-bottom: -3px;">
                    ...
                    <div class="col-sm-3">
                        <select class="form-control select2" name="un" style="width: 100%;">
                          <option selected="selected">{{$product->un}}</option>
                    ...
                    <div class="input-group col-sm-6">
                            <input type="text" name="ncm" onchange="ajaxLerNcm()" maxlength="8" value="{{$product->ncm}}" class="form-control @error('ncm') is-invalid @enderror" />
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <small id="ncmHelp" class="form-text text-info ncmdsc">{{$product->ncmDescr}}</small>
                    </div>
                </div>
